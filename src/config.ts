...
const envSchema = z.object({
  ...
  DEFAULT_PROVIDER: z.enum(["openai", "gemini", "anthropic", "ollama", "base44"]).default("gemini"),
  PROVIDER_FALLBACKS: z.string().default("gemini,anthropic,openai,ollama,base44"),
  TEXT_PROVIDER_ORDER: z.string().default("gemini,anthropic,openai,ollama,base44"),
  CODE_PROVIDER_ORDER: z.string().default("gemini,anthropic,openai,ollama,base44"),
